...
Set-Content -Path "C:\Users\samue\.gemini\antigravity\AGENTS.md" -Value $agentsContent -Encoding UTF8 -Force
...
Set-Content -Path "C:\Users\samue\.gemini\antigravity\skills\continuous-improver\SKILL.md" -Value $skillContent -Encoding UTF8 -Force

Remove-Item -Recurse -Force "C:\Users\samue\.gemini\config\skills\global-intelligence" -ErrorAction SilentlyContinue
